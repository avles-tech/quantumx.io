...
import { Admin, Resource, ThemeProvider, CustomRoutes } from 'react-admin';
...
import AttenadanceSummary from "../report/page";
  ...
  return (
    <ThemeProvider >
      ...
      <Admin dataProvider={myDataProvider} theme={theme} layout={QAppLayout} dashboard={Dashboard} authProvider={authProvider}>
        ...
        <CustomRoutes>
          <Route  path="/report" element={<AttenadanceSummary/>} />
